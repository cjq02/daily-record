			...
			<view class="u-tabbar__content__item" v-for="(item, index) in list" :key="index" :class="{
			 ...
			 @tap.stop="clickHandler(index)" :style="{
				...
				<view :class="[
					...
					<u-icon :name="elIconPath(index)" :size="midButton && item.midButton ? 'midButtonSize' : iconSize" class="u-icon" img-mode="scaleToFill"
				...
				<view class="u-tabbar__content__item__text" :style="{
					...
					<text class="u-line-1" style="font-size:26rpx;">{{item.text}}</text>
				</view>
			</view>
