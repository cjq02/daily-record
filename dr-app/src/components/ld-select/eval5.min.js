...
! function(e, t) {
	"object" === typeof exports && "object" === typeof module ? module.exports = t() : "function" === typeof define &&
		define.amd ? define([], t) : "object" === typeof exports ? exports.eval5 = t() : e.eval5 = t()
}(this, (function() {
	return function(e) {
		var t = {};
				...
				return "ForStatement" === e.type && (r = e.init ? this.createClosure(e.init) : r, n = e.update ? this.createClosure(
					...
					function(a) {
						...
						for (a && "LabeledStatement" === a.type && (o = a.label.name), r(); c || i(); n()) {
							...
							if (l !== d && l !== p) {
								if (l === u) break;
								if ((h = l) instanceof S && h.value === o) h = d;
								else if (h instanceof v || h instanceof b || h instanceof S) break
							}
						}
						return h
					}
				...
				return "VariableDeclaration" === e.left.type && (this.createClosure(e.left)(), r = e.left.declarations[0].id),
					function(e) {
						...
						for (a in h) {
							...
							if (c !== d && c !== p) {
								if (c === u) break;
								if ((o = c) instanceof S && o.value === s) o = d;
								else if (o instanceof v || o instanceof b || o instanceof S) break
							}
						}
						return o
					}
		...
		X.parseFunction = function(e, t, r, i) {
			...
			var r = this.startNode(),
				i = function(e, i) {
					...
					var n = t.start,
						s = t.startLoc;
					return !!t.eatContextual(e) && (!(t.type === _.parenL || i && t.canInsertSemicolon()) || (r.key && t.unexpected(),
			...
			if (this.shouldParseExportStatement()) e.declaration = this.parseStatement(null), "VariableDeclaration" === e.declaration
				.type ? this.checkVariableExport(t, e.declaration.declarations) : this.checkExport(t, e.declaration.id.name,
					e.declaration.id.start), e.specifiers = [], e.source = null;
			else {
				if (e.declaration = null, e.specifiers = this.parseExportSpecifiers(t), this.eatContextual("from")) this.type !==
					_.string && this.unexpected(), e.source = this.parseExprAtom();
				else {
		...
		te.toAssignable = function(e, t, r) {
			...
			for (var i = [], n = !0; !this.eat(e);)
				if (n ? n = !1 : this.expect(_.comma), t && this.type === _.comma) i.push(null);
				else {
		...
		re.parseNew = function() {
			...
			if ((r || i) && this.type === _.colon && this.unexpected(), this.eat(_.colon)) e.value = t ? this.parseMaybeDefault(
				this.start, this.startLoc) : this.parseMaybeAssign(!1, a), e.kind = "init";
			else if (this.options.ecmaVersion >= 6 && this.type === _.parenL) t && this.unexpected(), e.kind = "init", e.method = !
				0, e.value = this.parseMethod(r, i);
			else if (t || o || !(this.options.ecmaVersion >= 5) || e.computed || "Identifier" !== e.key.type || "get" !==
				...
				6 && !e.computed && "Identifier" === e.key.type ? ((r || i) && this.unexpected(), this.checkUnreserved(e.key),
					...
					this.parseMaybeDefault(n, s, e.key) : this.type === _.eq && a ? (a.shorthandAssign < 0 && (a.shorthandAssign =
						this.start), e.value = this.parseMaybeDefault(n, s, e.key)) : e.value = e.key, e.shorthand = !0) : this.unexpected();
			else {
			...
			for (var n = [], s = !0; !this.eat(e);) {
				if (s) s = !1;
				else if (this.expect(_.comma), t && this.afterTrailingComma(e)) break;
				var a = void 0;
		...
		Oe.next = function() {
			...
			for (var e, t, r = this.pos;;) {
				...
				if (C.test(i) && this.raise(r, "Unterminated regular expression"), e) e = !1;
				else {
					if ("[" === i) t = !0;
					else if ("]" === i && t) t = !1;
					else if ("/" === i && !t) break;
