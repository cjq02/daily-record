    ...
    <view class="location">
        <view class="search">
            ...
            <view class="clear" v-show="searchContent" @click="clearSearchChange">
                <image mode="widthFix" src="@/static/images/chooseLocation/close-icon.png">
            </view>
        </view>
        <view class="content">
...
export default {
    ...
    methods: {
        ...
        markerFunc (point) {
            ...
            this.Marker.setIcon('static/images/chooseLocation/marker-icon.png');
        ...
        drawRectClose () {
            ...
            close.drawBitmap('static/images/chooseLocation/close-icon.png', {}, {
                top: '7.5px',
                left: '7.5px',
                width: '15px',
                height: '15px'
        ...
        drawRectCenter () {
            ...
            center.drawBitmap('static/images/chooseLocation/center-icon.png', {}, {
                top: '5px',
                left: '5px',
                width: '20px',
                height: '20px'
